...
- `task`: one of `embed`, `rerank`, `generate`, `raw`, `embed_image`, `embed_audio`, `embed_multimodal`, `embed_sparse`, `embed_multi_vector`, `nlp`, `document_extract`, `transcribe`, `ocr`.
