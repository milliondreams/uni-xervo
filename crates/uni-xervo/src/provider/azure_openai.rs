    ...
    async fn embed(&self, texts: &[&str]) -> Result<EmbedResult> {
        ...
        self.cb
            .call(move || async move {
                ...
                // Azure OpenAI embeddings response (OpenAI-compatible) carries a
...
impl crate::traits::ModelInfo for AzureOpenAIEmbeddingModel {
...
impl crate::traits::ModelInfo for AzureOpenAIGeneratorModel {
    fn model_id(&self) -> &str {
        &self.deployment
    }
}
